...
class TestIntegrationScenarios(unittest.TestCase):
    ...
    def test_malicious_site_then_safe_site(self):
        ...
        for _ in range(10):
            belief = self.tracker.update_belief(
                domain, "https://mixed-site.com/good-content"
            )
...
class TestRegressionScenarios(unittest.TestCase):
    ...
    def test_edge_case_borderline_reputation(self):
        ...
        print(
            f"Borderline test: reputation 0.51 -> {result}, reputation 0.49 -> {action.allow}"
        )
    ...
    def test_many_suspicious_activities(self):
        ...
        for i in range(20):
            self.tracker.update_belief(
                domain, f"https://many-suspicious.com/tracker{i}"
            )
